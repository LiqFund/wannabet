  ...
  return (
    <div className="grid gap-6 lg:grid-cols-3">
      <form onSubmit={onSubmit} className="space-y-4 rounded-lg border border-white/15 bg-panel/95 p-5 shadow-glow lg:col-span-2">
        ...
        <button disabled={loading} className="rounded-md border border-neon/30 bg-neon/20 px-5 py-3 font-semibold text-neon hover:border-neon/50 hover:bg-neon/30 disabled:opacity-60">{loading ? 'Creating...' : 'Create Bet'}</button>
      </form>
