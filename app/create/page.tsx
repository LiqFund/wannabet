  ...
  Football: [
    {
      ...
      b: "Ravens",
      startsAt: "Sun 20:20",
      label: "NFL: Chiefs vs Ravens (Sun 20:20)",
    },
    {
      id: "nfl-2",
      a: "49ers",
      b: "Cowboys",
      startsAt: "Sun 16:25",
      label: "NFL: 49ers vs Cowboys (Sun 16:25)",
    },
    {
      id: "nfl-3",
      a: "Bills",
      b: "Dolphins",
      startsAt: "Mon 20:15",
      label: "NFL: Bills vs Dolphins (Mon 20:15)",
    },
    {
      id: "nfl-4",
      a: "Bengals",
      b: "Steelers",
      startsAt: "Thu 20:15",
      label: "NFL: Bengals vs Steelers (Thu 20:15)",
    },
  ],
  Basketball: [
    {
      ...
      b: "Warriors",
      startsAt: "Tue 03:00",
      label: "NBA: Lakers vs Warriors (Tue 03:00)",
    },
    {
      id: "nba-2",
      a: "Celtics",
      b: "Bucks",
      startsAt: "Wed 01:30",
      label: "NBA: Celtics vs Bucks (Wed 01:30)",
    },
    {
      id: "nba-3",
      a: "Nuggets",
      b: "Suns",
      startsAt: "Fri 02:00",
      label: "NBA: Nuggets vs Suns (Fri 02:00)",
    },
    {
      id: "nba-4",
      a: "Knicks",
      b: "Heat",
      startsAt: "Sat 00:30",
      label: "NBA: Knicks vs Heat (Sat 00:30)",
    },
  ],
  Baseball: [
    {
      ...
      b: "Red Sox",
      startsAt: "Tue 19:10",
      label: "MLB: Yankees vs Red Sox (Tue 19:10)",
    },
    {
      id: "mlb-2",
      a: "Dodgers",
      b: "Giants",
      startsAt: "Wed 22:10",
      label: "MLB: Dodgers vs Giants (Wed 22:10)",
    },
    {
      id: "mlb-3",
      a: "Astros",
      b: "Mariners",
      startsAt: "Thu 20:10",
      label: "MLB: Astros vs Mariners (Thu 20:10)",
    },
    {
      id: "mlb-4",
      a: "Cubs",
      b: "Cardinals",
      startsAt: "Fri 14:20",
      label: "MLB: Cubs vs Cardinals (Fri 14:20)",
    },
  ],
  Hockey: [
    {
      ...
      b: "Bruins",
      startsAt: "Tue 19:00",
      label: "NHL: Rangers vs Bruins (Tue 19:00)",
    },
    {
      id: "nhl-2",
      a: "Oilers",
      b: "Canucks",
      startsAt: "Wed 21:30",
      label: "NHL: Oilers vs Canucks (Wed 21:30)",
    },
    {
      id: "nhl-3",
      a: "Maple Leafs",
      b: "Canadiens",
      startsAt: "Thu 19:30",
      label: "NHL: Maple Leafs vs Canadiens (Thu 19:30)",
    },
    {
      id: "nhl-4",
      a: "Avalanche",
      b: "Stars",
      startsAt: "Sat 20:00",
      label: "NHL: Avalanche vs Stars (Sat 20:00)",
    },
  ],
  Soccer: [
    {
      ...
      b: "Chelsea",
      startsAt: "Sat 17:30",
      label: "EPL: Arsenal vs Chelsea (Sat 17:30)",
    },
    {
      id: "epl-2",
      a: "Liverpool",
      b: "Tottenham",
      startsAt: "Sun 16:30",
      label: "EPL: Liverpool vs Tottenham (Sun 16:30)",
    },
    {
      id: "epl-3",
      a: "Man City",
      b: "Newcastle",
      startsAt: "Sat 12:30",
      label: "EPL: Man City vs Newcastle (Sat 12:30)",
    },
    {
      id: "epl-4",
      a: "Man United",
      b: "Brighton",
      startsAt: "Sun 14:00",
      label: "EPL: Man United vs Brighton (Sun 14:00)",
    },
  ],
  MMA: [
    {
      ...
      b: "Fighter B",
      startsAt: "Sat 22:00",
      label: "UFC: Fighter A vs Fighter B (Sat 22:00)",
    },
    {
      id: "ufc-2",
      a: "Fighter C",
      b: "Fighter D",
      startsAt: "Sat 21:30",
      label: "UFC: Fighter C vs Fighter D (Sat 21:30)",
    },
    {
      id: "ufc-3",
      a: "Fighter E",
      b: "Fighter F",
      startsAt: "Sat 20:45",
      label: "UFC: Fighter E vs Fighter F (Sat 20:45)",
    },
    {
      id: "ufc-4",
      a: "Fighter G",
      b: "Fighter H",
      startsAt: "Sat 20:00",
      label: "UFC: Fighter G vs Fighter H (Sat 20:00)",
    },
  ],
  Boxing: [
    {
      ...
      b: "Boxer B",
      startsAt: "Fri 23:00",
      label: "Boxing: Boxer A vs Boxer B (Fri 23:00)",
    },
    {
      id: "box-2",
      a: "Boxer C",
      b: "Boxer D",
      startsAt: "Sat 22:30",
      label: "Boxing: Boxer C vs Boxer D (Sat 22:30)",
    },
    {
      id: "box-3",
      a: "Boxer E",
      b: "Boxer F",
      startsAt: "Sat 21:45",
      label: "Boxing: Boxer E vs Boxer F (Sat 21:45)",
    },
    {
      id: "box-4",
      a: "Boxer G",
      b: "Boxer H",
      startsAt: "Sun 00:15",
      label: "Boxing: Boxer G vs Boxer H (Sun 00:15)",
    },
  ],
};
...
> = {
  ...
  Soccer: {
    markets: ["Moneyline", "Total", "Draw No Bet"],
    allowDraw: true,
    totalUnit: "goals",
  },
  MMA: {
...
const SPORTS_MARKET_DESC: Record<SportsMarket, string> = {
  ...
  "Draw No Bet":
    "Pick a side; if the match ends in a draw, this is treated as a refund.",
...
export default function BetCreatePage() {
  ...
  const fromUtcInputValue = (value: string) =>
    value ? new Date(`${value}:00Z`).toISOString() : "";
  ...
  const bOptions = useMemo(
    () => UNDERLYINGS_BY_SECTOR[sector].filter((u) => u.id !== underlyingA),
    [sector, underlyingA]
  );
  ...
  const selectedEvent = useMemo(
    () => sportEvents.find((event) => event.id === eventId) ?? null,
    [sportEvents, eventId]
  );
  ...
  const summary = useMemo(() => {
    if (sector === "Sports") {
      const eventLabel = selectedEvent
        ? `${selectedEvent.a} vs ${selectedEvent.b} (${selectedEvent.startsAt})`
        : "No event selected";
      let sportsCondition = "";
  ...
  async function handleCreateBet() {
    ...
    try {
      ...
      if (makerAmountBaseUnits <= 0) {
        setSubmitError("Maker stake must be greater than 0.");
        return;
      }

      if (takerAmountBaseUnits <= 0) {
        setSubmitError("Opponent stake required must be greater than 0.");
        return;
      }

      if (safeOddsX <= 0 || safeOddsX > 100) {
        setSubmitError("Odds must stay between 1:1 and 100:1.");
        return;
      }

      if (!Number.isFinite(derivedExpiryTs) || derivedExpiryTs <= 0) {
        setSubmitError("Choose a valid expiry.");
        return;
      }

      const now = Math.floor(Date.now() / 1000);
      if (derivedExpiryTs <= now + 60) {
        setSubmitError("Expiry must be at least 60 seconds in the future.");
        return;
      }
      ...
      const tx = await program.methods
        .createBet(
          ...
          new BN(takerAmountBaseUnits),
          new BN(derivedExpiryTs)
        )
        .accounts({
            ...
            <div className="flex flex-col gap-6">
              <SectionCard title="Title" subtitle="Start here">
                <div className="flex flex-col gap-4">
                  <FieldRow
                    label="Bet title"
                    hint="Name the bet first. If empty, we use a default."
                  >
                    <Input
                      value={title}
                      onChange={(e) => setTitle(e.target.value)}
                      placeholder="e.g. BTC above 100k in 90 days"
                    />
                  </FieldRow>
                      ...
                      >
                        <span
                          className={clsx(
                            ...
                            isPrivate
                              ? "translate-x-5 bg-[rgba(212,175,55,0.95)]"
              ...
              <SectionCard
                title={isSports ? "2) Bet market" : "2) Bet type"}
                subtitle="Step 2"
              >
                <div className="flex flex-col gap-5">
                  {isSports ? (
                    <>
                      <FieldRow
                        label="Market"
                        hint="Available markets depend on sport."
                        right={<Pill>Required</Pill>}
                      >
                        <Select
                          value={sportsMarket}
                      ...
                      {sportsMarket === "Total" ? (
                        <>
                          ...
                          <FieldRow
                            label={`Total ${activeSportMarkets.totalUnit} line`}
                            hint="Set the total line value."
                            right={<Pill>Required</Pill>}
                          >
                            <Input
                              value={totalLine}
                              onChange={(e) => setTotalLine(e.target.value)}
                              placeholder={`e.g. 2.5 ${activeSportMarkets.totalUnit}`}
                            />
                          </FieldRow>
                        </>
                      ) : null}
                      ...
                      {sportsMarket === "Spread" ? (
                        <>
                          <FieldRow
                            label="Pick / Outcome"
                            hint="Pick the side against the spread."
                            right={<Pill>Required</Pill>}
                          >
                            <Select
                              value={pick}
                      ...
                      {sportsMarket === "Method" ? (
                        <>
                          ...
                          <FieldRow
                            label="Method"
                            hint="How the winner gets it done."
                            right={<Pill>Required</Pill>}
                          >
                            <Select
                              value={methodPick}
                    ...
                    <div className="flex flex-col gap-5">
                      {canUseB ? (
                        ...
                        >
                          <Select
                            value={underlyingB}
                            onChange={(e) => setUnderlyingB(e.target.value)}
                          >
                            {bOptions.map((u) => (
                              <option key={u.id} value={u.id}>
                                {u.label}
                  ...
                  <SectionCard title="4) Timing" subtitle="Step 4">
                    <div className="flex flex-col gap-5">
                      ...
                      {expiryPreset === "Custom" ? (
                        <FieldRow
                          label="Expiry date"
                          hint="Frontend only. Any date format is accepted."
                        >
              ...
              <SectionCard
                title={isSports ? "4) Stake" : "5) Stake"}
              ...
              >
                <div className="flex flex-col gap-5">
                  ...
                  <FieldRow
                    label="Odds offered"
                    hint="Defines opponent escrow requirement as maker stake divided by X."
                  >
                  ...
                  <FieldRow
                    label="Opponent stake required"
                    hint="Calculated as maker stake divided by X."
                  >
